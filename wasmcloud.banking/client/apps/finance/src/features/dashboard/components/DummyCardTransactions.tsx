...
import {ArrowLeftRightIcon, ArrowRightIcon, CreditCardIcon, SignatureIcon} from 'lucide-react';
import {useTransactions, Transaction} from '@repo/common/services/user/useTransactions';
import {DashboardCard} from './DashboardCard';

export function DummyCardTransactions(): React.ReactElement {
    ...
    <DashboardCard cols={12}>
      <div className="p-2">
        <div className="sm:flex items-center justify-between">
          ...
          <a
            href="#"
            className="inline-flex items-center gap-3 text-primary hover:text-primary-400 transition-colors duration-300"
          >
