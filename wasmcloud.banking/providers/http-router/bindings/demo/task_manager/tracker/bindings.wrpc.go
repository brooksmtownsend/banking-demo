...
func Start(ctx__ context.Context, wrpc__ wrpc.Invoker, clientLocation string, originalAsset string) (r0__ *wrpc.Result[string, OperationError], err__ error) {
	...
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[string, OperationError], error) {
		...
		case 1:
			...
			v, err := func() (*OperationError, error) {
				v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*demo__task_manager__types.OperationError, error) {
...
func Get(ctx__ context.Context, wrpc__ wrpc.Invoker, id string) (r0__ *wrpc.Result[Operation, OperationError], err__ error) {
	...
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[Operation, OperationError], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
		...
		case 0:
			...
			v, err := func() (*Operation, error) {
				v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*demo__task_manager__types.Operation, error) {
					...
					v.ResizedAsset, err = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
					...
					v.ResizeError, err = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
					...
					v.ResizedAt, err = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
					...
					v.AnalyzeResult, err = func(r wrpc.IndexReadCloser, path ...uint32) (*bool, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
					...
					v.AnalyzeError, err = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
					...
					v.AnalyzedAt, err = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
...
func CompleteResize(ctx__ context.Context, wrpc__ wrpc.Invoker, id string, resizedAsset *string, resizeError *string) (r0__ *wrpc.Result[struct{}, OperationError], err__ error) {
	...
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, OperationError], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
...
func List(ctx__ context.Context, wrpc__ wrpc.Invoker) (r0__ *wrpc.Result[[]*demo__task_manager__types.Operation, OperationError], err__ error) {
	...
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[[]*demo__task_manager__types.Operation, OperationError], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
