...
import (
	...
	errors "errors"
	fmt "fmt"
	wasi__http__types "github.com/cosmonic-labs/wasmcloud.space/providers/http-router/bindings/wasi/http/types"
	wrpc__http__types "github.com/cosmonic-labs/wasmcloud.space/providers/http-router/bindings/wrpc/http/types"
	io "io"
	slog "log/slog"
	sync "sync"
	utf8 "unicode/utf8"
		...
		case 0:
			...
			v, err := func() (*Response, error) {
				v, err := func(r wrpc.IndexReader, path ...uint32) (*wrpc__http__types.Response, error) {
					...
					v.Body, err = func(r wrpc.IndexReader, path ...uint32) (io.Reader, error) {
					...
					v.Trailers, err = func(r wrpc.IndexReader, path ...uint32) (wrpc.Receiver[[]*wrpc.Tuple2[string, [][]uint8]], error) {
